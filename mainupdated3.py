...
armoursize = 126
armouroffset = [50,22]
armourdata = [armoursize, armourscale, armouroffset]
...
armourshit = pygame.image.load("hello/image/bossmans/somalian.png").convert_alpha()
...
f5img = pygame.image.load("hello/image/icon/armour.png").convert_alpha()
f5img_set_image_size = (100,150)
f5img_okuz = pygame.transform.scale(f5img, f5img_set_image_size)


f6img = pygame.image.load("hello/image/icon/king.png").convert_alpha()
f6img_set_image_size = (100,150)
f6img_flip = pygame.transform.flip(f6img, True, False)
f6img_okuz = pygame.transform.scale(f6img, f6img_set_image_size)
...
def fighter_move():
    if f1 == True:
        fighter_1.move(SCREEN_WIDTH, SCREEN_HEIGHT, screen, fighter_2, fighter_4, round_over)
    if f2 ==  True:
        fighter_2.move(SCREEN_WIDTH, SCREEN_HEIGHT, screen, fighter_1, fighter_3, round_over)
    if f3 == True:
        fighter_3.move(SCREEN_WIDTH, SCREEN_HEIGHT, screen, fighter_2, fighter_6, round_over)
    if f4 ==  True:
        fighter_4.move(SCREEN_WIDTH, SCREEN_HEIGHT, screen, fighter_1, fighter_3, round_over)
    if f5 ==  True:
        fighter_5.move(SCREEN_WIDTH, SCREEN_HEIGHT, screen, fighter_2, fighter_4, round_over)
    if f6 ==  True:
        fighter_6.move(SCREEN_WIDTH, SCREEN_HEIGHT, screen, fighter_1, fighter_3, round_over)
...
fighter_5 = Fighter(1, 200 , 310, False,  armourdata, armourshit, armoursteps, cheff_fx )
...
warrior_button = Button(SCREEN_WIDTH // 2 - 250, SCREEN_HEIGHT // 2 + 25, f1img_okuz)
...
start_button2 = Button(SCREEN_WIDTH // 2 - 100, SCREEN_HEIGHT // 2 + 100, startimg_okuz)
...
fire_button = Button(SCREEN_WIDTH // 2 + 250, SCREEN_HEIGHT // 2 + 25, f6img_okuz)
