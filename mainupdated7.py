...
def main():
    ...
    restart_resize = pygame.transform.scale(restartimg, restart_image_size)
    exitimg_transform = pygame.transform.scale(exitimg2, exit_set_image_size2)
    ...
    gimg_set = (500, 100)
    name_okuz = pygame.transform.scale(gametitle, gimg_set)
    ...
    restart_button = Button(SCREEN_WIDTH // 2 - 100, SCREEN_HEIGHT // 2 , restart_resize)
    exit_button2 = Button(SCREEN_WIDTH // 2 - 100, SCREEN_HEIGHT // 2 + 150, exitimg_transform)
