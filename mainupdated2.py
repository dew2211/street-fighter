...
f4img = pygame.image.load("hello/image/icon/ussop.png").convert_alpha()
...
def fighter_move():
    ...
    if f3 == True:
        fighter_3.move(SCREEN_WIDTH, SCREEN_HEIGHT, screen, fighter_2, fighter_4, round_over)
    if f4 ==  True:
...
start_button5 = Button(SCREEN_WIDTH // 2 + 150, SCREEN_HEIGHT // 2 + 100, startimg_okuz)
